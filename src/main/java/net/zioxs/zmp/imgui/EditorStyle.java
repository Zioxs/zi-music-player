...
public final class EditorStyle
{
    ...
    public static void apply(ImGuiStyle s)
    {
        ...
        col(s, ImGuiCol.FrameBgHovered,  0x43, 0x24, 0xb3);
        col(s, ImGuiCol.FrameBgActive,   0x43, 0x24, 0xb3);
        ...
        col(s, ImGuiCol.ButtonActive,    0x74, 0x57, 0xe4);

        col(s, ImGuiCol.Header,          0x74, 0x57, 0xe4);
        col(s, ImGuiCol.HeaderHovered,   0x43, 0x24, 0xb3);
        col(s, ImGuiCol.HeaderActive,    0x74, 0x57, 0xe4);

        col(s, ImGuiCol.Tab,             0x2a, 0x2a, 0x2a);
        col(s, ImGuiCol.TabHovered,      0x43, 0x24, 0xb3);
        col(s, ImGuiCol.TabActive,       0x74, 0x57, 0xe4);
        col(s, ImGuiCol.TabUnfocused,    0x2a, 0x2a, 0x2a);
        col(s, ImGuiCol.TabUnfocusedActive, 0x43, 0x24, 0xb3);

        col(s, ImGuiCol.CheckMark,       0x74, 0x57, 0xe4);
        col(s, ImGuiCol.SliderGrab,      0x74, 0x57, 0xe4);
        col(s, ImGuiCol.SliderGrabActive, 0x74, 0x57, 0xe4);
